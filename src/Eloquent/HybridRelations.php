...
use Code\MongoDb\Helpers\EloquentBuilder;
use Code\MongoDb\Relations\BelongsTo;
use Code\MongoDb\Relations\BelongsToMany;
use Code\MongoDb\Relations\HasMany;
use Code\MongoDb\Relations\HasOne;
use Code\MongoDb\Relations\MorphMany;
use Code\MongoDb\Relations\MorphTo;
...
trait HybridRelations
{
    ...
    public function hasOne($related, $foreignKey = null, $localKey = null)
    {
        ...
        if (! is_subclass_of($related, \Code\MongoDb\Eloquent\Model::class)) {
    ...
    {
        if (is_subclass_of($this, \Code\MongoDb\Eloquent\Model::class)) {
